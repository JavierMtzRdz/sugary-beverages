...
After model fitting, the assumption that the error terms are independent identically distributed Normal variables with mean zero for LME needs to be confirmed by plotting the residuals.
