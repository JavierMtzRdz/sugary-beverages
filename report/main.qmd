...
For the second question regarding the difference in intervention effects between sites, the results are summarized in @fig-q2. It is interesting to note that discount plus messaging has different effect across sites for both zero-calorie and sugary beverages.
